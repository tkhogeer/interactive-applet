...
public class InteractiveApplet extends HttpServlet{
	...
	public void doPost( HttpServletRequest request, HttpServletResponse response)
		...
		if ((shapeWValue.equals("")) || (Integer.parseInt(shapeWValue)>500) || (Integer.parseInt(shapeWValue)<10) ) {
		...
		if ((shapeHValue.equals("")) || (Integer.parseInt(shapeHValue)>500) || (Integer.parseInt(shapeHValue)<10) ) {
			JOptionPane.showMessageDialog(null, "Please enter shape height between 10-500", "Error", JOptionPane.ERROR_MESSAGE);
		} else {
			shapeH = (Integer.parseInt(shapeHValue));
		}
		
		//check and set appW
		if (( appWValue.equals("")) || (Integer.parseInt(appWValue)>500) || (Integer.parseInt(appWValue)<10) ) {
			JOptionPane.showMessageDialog(null, "Please enter applet width between 10-500", "Error", JOptionPane.ERROR_MESSAGE);
		} else {
			appW = (Integer.parseInt(appWValue));
		}
		
		//check and set appH
		if ((appHValue.equals("")) || (Integer.parseInt(appHValue)>700) || (Integer.parseInt(appHValue)<50) ) {
			JOptionPane.showMessageDialog(null, "Please enter applet height between 10-500", "Error", JOptionPane.ERROR_MESSAGE);
		} else {
		...
		buf.append("<select name=fontSize id=fontSize value="+fSize+" class=\"custom-select custom-select-sm\" >\n"); //font sizes dropdown
		...
		buf.append("<param name=fSize value=" + fSize + ">\n");
		buf.append("<param name=fontC value=" + fontC + ">\n");
